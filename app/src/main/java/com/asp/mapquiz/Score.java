...
public class Score {
    ...
    public Score(long playerID, boolean correct, StateOption selectedStateOption, List<StateOption> stateOptions, long duration){
        mPlayerID = playerID;
        mCorrect = correct;
        mStateOption = selectedStateOption;
        mStateOptions = stateOptions;
        mDuration = duration;
    }
